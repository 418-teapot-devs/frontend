...
test("should register", async () => {
  ...
  expect(
    await screen.findByText(/Se creó el usuario con éxito/i)
  ).toBeInTheDocument()
})
...
test("taken username no avatar", async () => {
  ...
  expect(
    await screen.findByText(/El nombre de usuario ya está en uso/i)
  ).toBeInTheDocument()
  expect(
...
test("unknown error", async () => {
  ...
  expect(
    await screen.findByText(/No se pudo crear el usuario/i)
  ).toBeInTheDocument()
})
